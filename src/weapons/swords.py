...
from src.utils import Time, rotate, resize, mod_alpha
...
class Sword:
    ...
    def create_wind_slash(self, player_pos: tuple, mouse_pos: tuple, camera: Vec):
    ...
    def update(self, event_info: EventInfo, player_pos: tuple, camera: Vec) -> None:
