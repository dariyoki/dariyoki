...
from dariyoki.effects.particle_effects import ShurikenContrail
from dariyoki.utils import circle_surf
from dariyoki.weapons.projectiles import Projectile
...
class Shuriken(Projectile):
    ...
    def collides(self, rect: pygame.Rect, camera: Vec) -> None:
